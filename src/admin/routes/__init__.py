...
from src.admin.routes.weekly_top_students import router as weekly_top_students_router
from src.admin.routes.recordings import router as recordings_admin_router

__all__ = [
    "admin_router", "dashboard_router", "head_teacher_router",
    "analytics_router", "media_router", "sat_schedules_router",
    "weekly_top_students_router", "recordings_admin_router",
]
