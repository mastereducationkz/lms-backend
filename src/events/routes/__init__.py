...
from src.events.routes.meet_talk import router as meet_talk_router
from src.events.routes.watch_links import internal_router as watch_links_internal_router
from src.events.routes.watch_links import public_router as watch_links_public_router

__all__ = [
    "events_router", "lesson_recordings_router", "recording_library_router", "meet_attendance_router",
    "meet_talk_router",
